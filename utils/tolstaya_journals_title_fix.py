...
TITLE_MAP = {
    "Толстая С. А. Ежедневники, 1905—1910 // Толстая С. А. Дневники: В 2 т. — М.: Худож. лит., 1978 . — Т. 2: 1901—1910. — С. 227—478. — (Сер. лит. мемуаров).": "Толстая С. А. Ежедневники, 1905—1910 // Толстая С. А. Дневники: В 2 т. М.: Худож. лит., 1978. Т. 2. С. 227—478.",
    }
...
def main():
    ...
    for i, xml_file in enumerate(iter_xml_files(makovitski_path)):
        fn = xml_file.stem
        if not fn.startswith("tolstaya-s-a-journals_"):
            continue
