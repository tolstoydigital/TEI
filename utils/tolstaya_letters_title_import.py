...
def main():
    ...
    new_file_prefix = "tolstaya-s-a-letters_"

    # last_git_hash = git_short_sha()

    reference_path = (
        BASE_DIR.parent / "utils" / "doc" / "! tolstaya-s-a-letters_d831e869e1f.xlsx"
    )
